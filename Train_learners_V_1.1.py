...
pdPdFrm_Train_Tweets1 = pd.read_csv(os.path.join(_input_path , "Train_Data.csv"),encoding = "ISO-8859-1")
...
#pickle the features 
save_word_ft = open("word_features5k.pickle","wb")
...
save_classifier = open("MultinomialNB_classifier5k.pickle","wb")
...
save_classifier = open("AdaBoost_LinSVC_classifier.pickle","wb")
...
print("AdaBoost_LR_Classifier accuracy % : ",(nltk.classify.accuracy(AdaBoost_LR_Classifier,\
 testing_set)) *100)  
print("Saving AdaBoostClassifier Classifier with  LogisticRegression....")                                                        
save_classifier = open("AdaBoost_LR_classifier.pickle","wb")
